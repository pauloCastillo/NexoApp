...
class ReportRepositoryImpl implements ReportRepository {
  ...
  Future<void> shareExcel(Uint8List bytes, {String fileName = 'reporte.xlsx'}) async {
    final xfile = XFile.fromData(bytes, name: fileName, mimeType: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
    await Share.shareXFiles([xfile], text: 'Reporte Nexo');
  }
}